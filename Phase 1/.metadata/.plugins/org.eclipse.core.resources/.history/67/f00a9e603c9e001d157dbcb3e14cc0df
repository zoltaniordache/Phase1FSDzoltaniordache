				...
				while(inputBoolean1 == false) {
				 ...
				 {	 System.out.println("Please insert the path of directory to sort:");
				 	 ...
				 	 if(folder.isDirectory()) {
				 		 DisplayFiles.main(folder);
				 		 mainUserChoice=0;//Show main menu
				 		 break;
				 	 }
				 	 else {
				 		System.out.println("Path does not exist. Please insert a correct path!" );
				 		inputChoice1=0;//Show sub menu
			...
			if(mainUserChoice==2) {
				...
				while(inputBoolean1 == false) {
					...
					if(inputChoice1==1) {
							  ...
							  inputChoice1=0;//keep application in File related actions submenu
							 // break;
